...
//Retorna um vetor com numeros aleatórios com distribuição normal com média s e desvio s
__kernel void BoxMuller(__global float *restrict result,
                        __global int *restrict final_size,
                        ...
                        const int size )
{
    ...
    for(int i = 0; i < size; i+=2){        
        ...
        do {
            ...
            float r1 = input_buffer[j];

            float r2 = input_buffer[j+1];
